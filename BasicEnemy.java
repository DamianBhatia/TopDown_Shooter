 ...
 * enemy Class
 * This class extends and enemy class and provides all components of an enemy as well as other basic enemy components
 * 2019-05-31
 */
...
public class BasicEnemy extends Enemy {
  ...
  public float distance, diffX, diffY;
  ...
  public void update() {
    ...
    this.distance = (float)Math.sqrt((this.getX() - this.player.getX()) * (this.getX() - this.player.getX()) + (this.getY() - this.player.getY()) * (this.getY() - this.player.getY()));
